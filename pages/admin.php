<div id="tabs">
  ...
  <div id="fragment-1" class="row">
    <div class="col-md-6 col-sm-12">
		...
		<form action="index.php?page=5" method="post" class="form-inline">
			<input type="text" placeholder="категория..." name="newcat"  class="form-control">
	...
	<div class="col-md-6 col-sm-12">
    	...
    	<form action="index.php?page=5" method="post" class="form-inline">
    		...
    		<input  type="text" placeholder="подкатегория..." name="newsub" class="form-control">
  ...
  <div id="fragment-2">
    ...
    <form action="index.php?page=5#fragment-2" method="post" class="input-group"  enctype="multipart/form-data">
    	...
    	<select name="catid" id="" onchange="showSC(this.value)">
	    <option value="0">Выберите категорию</option>
	    	<?php 
	    		$sel=$pdo->prepare('select * from categories');
				$sel->execute();
		...
		<input type="submit" name="additem" value="Добавить" class="btn btn-default">
		</form>
	<?php 
  ...
  <div id="fragment-3">
    ...
    <form action="index.php?page=5#fragment-3" method="post" class="input-group"  enctype="multipart/form-data">
    	<div class="input-group">
    		<select name="catid" id="" onchange="showSC2(this.value)">
    		<option value="0">Выберите категорию</option>
	    		<?php 
	    			$sel=$pdo->prepare('select * from categories');
					$sel->execute();
    	...
    	<input type="submit" name="addpics" value="Добавить" class="btn btn-default">
    </form>
	<?php 
